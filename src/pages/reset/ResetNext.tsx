...
const FAQ = [
  {
    ...
    a: 'Der Caliness-Sprint startet ab 149€ — einmalig, kein Abo. Dafür bekommst du einen individuellen Plan und 2 Wochen persönliche Begleitung durch David oder Sarah.',
  },
  {
    q: 'Was wenn der Sprint nichts bringt?',
    a: 'Wenn du nach 7 Tagen Sprint das Gefühl hast, es hat dir nichts gebracht — bekommst du dein Geld zurück. Kein Kleingedrucktes, keine Diskussion. Wir stehen für das, was wir versprechen.',
  },
  {
    ...
    <div className="min-h-screen bg-background flex flex-col px-6 py-10">
      <div className="max-w-sm mx-auto w-full animate-fade-in">
        ...
        <button
          ...
          className="w-full min-h-[52px] rounded-xl flex items-center justify-center gap-2 text-base font-semibold transition-all duration-200 mb-2"
          style={{ background: 'hsl(142 76% 46% / 1)', color: '#000', boxShadow: '0 0 24px hsl(142 76% 46% / 0.4)' }}
        >
        ...
        >
          <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current text-muted-foreground/50" xmlns="http://www.w3.org/2000/svg">
          ...
          Lieber per Instagram DM schreiben
        </button>

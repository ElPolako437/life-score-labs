...
import { ArrowRight, Target, Clock, Sparkles, Shield } from "lucide-react";
import { Link } from "react-router-dom";

interface BestformLandingProps {
  onStart: () => void;
}

export const BestformLanding = ({ onStart }: BestformLandingProps) => {
  const benefits = [
    {
      icon: Target,
      title: "Individuelle Zielanalyse",
      description: "Berechnung basierend auf deinen echten Körperdaten und Gewohnheiten",
    },
    {
      icon: Clock,
      title: "Realistische Zeitprognose",
      description: "Keine leeren Versprechen – sondern eine ehrliche Einschätzung",
    },
    {
      icon: Sparkles,
      title: "Sofortige Auswertung",
      description: "Direktes Feedback mit konkreten Empfehlungen",
    },
    {
      icon: Shield,
      title: "DSGVO-konform",
        ...
        <div className="max-w-7xl mx-auto px-5 md:px-8">
          <article className="text-center mb-20 md:mb-28 animate-enter">
            ...
            <p className="text-xl md:text-2xl text-text-secondary mb-4 font-medium">
              Berechne realistisch, wann du dein Ziel erreichst.
            </p>

            <p className="text-lg md:text-xl text-text-muted max-w-3xl mx-auto mb-4 leading-relaxed body-text">
              Dieser Calculator analysiert Körperdaten, Training und Regeneration und gibt dir eine
              realistische Zeitprognose für Fettverlust, Straffung oder Muskelaufbau.
            </p>
            <p className="text-base md:text-lg text-primary font-medium mb-12 md:mb-16">
              Realistische Prognose statt Wunschdenken.
            </p>
            ...
            <div className="mb-20 md:mb-24">
              ...
              <p className="text-sm md:text-base text-text-muted mt-6 md:mt-8 tracking-wide">
                2 Minuten · kostenlos · klare Prognose
              </p>
            </div>
          </article>
          ...
          <section className="mb-20 md:mb-28" aria-labelledby="benefits-heading">
            <div className="flex items-center justify-center gap-4 mb-12 md:mb-16">
              <h2 id="benefits-heading" className="section-title text-2xl md:text-3xl lg:text-4xl font-bold text-center">
                Deine realistische Prognose – datenbasiert
              </h2>
            </div>
